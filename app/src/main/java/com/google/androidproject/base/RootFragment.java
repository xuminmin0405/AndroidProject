package com.google.androidproject.base;
...
import com.google.androidproject.R;
...
public abstract class RootFragment<T extends BasePresenter> extends BaseFragment<T> {
    ...
    public void initViews(@Nullable Bundle savedInstanceState) {
        viewMain = mRootView.findViewById(R.id.viewMain);
        if (viewMain == null) {
        ...
        viewLoading = mParent.findViewById(R.id.viewLoading);
        //设置错误页
        View.inflate(mContext, R.layout.view_error, mParent);
        viewError = mParent.findViewById(R.id.viewError);
        //设置默认显示
