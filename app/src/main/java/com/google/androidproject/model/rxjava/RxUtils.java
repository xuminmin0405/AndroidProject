package com.google.androidproject.model.rxjava;

import com.google.androidproject.model.bean.BaseResponse;
import com.google.androidproject.model.exception.ApiException;
                ...
                return httpResponseFlowable.flatMap(new Function<BaseResponse<T>, Flowable<T>>() {
                    ...
                    public Flowable<T> apply(BaseResponse<T> baseResponse) {
                        if (baseResponse.isSuccess()) {
                            ...
                            return Flowable.error(new ApiException(baseResponse.getErrorMessage(), baseResponse.getErrorNumber()));
                        }
                    }
                });
            }
